...
const ChestCableFlat = ({ color }: { color: string }) => (
  ...
  <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md">
    ...
    <g>
      <animate attributeName="opacity" values="1;0;1" keyTimes="0;0.5;1" dur="2s" repeatCount="indefinite"/>
      <path d="M 38 30 L 25 35 M 62 30 L 75 35" stroke={color} strokeWidth="4.5" fill="none" strokeLinecap="round"/>
      <line x1="0" y1="90" x2="25" y2="35" stroke="#777" strokeWidth="1.5"/>
      <line x1="100" y1="90" x2="75" y2="35" stroke="#777" strokeWidth="1.5"/>
      <circle cx="25" cy="35" r="3" fill="#e5e5e5"/>
      <circle cx="75" cy="35" r="3" fill="#e5e5e5"/>
    </g>
    <g opacity="0">
      <animate attributeName="opacity" values="0;1;0" keyTimes="0;0.5;1" dur="2s" repeatCount="indefinite"/>
      <path d="M 38 30 L 47 45 M 62 30 L 53 45" stroke={color} strokeWidth="4.5" fill="none" strokeLinecap="round"/>
      <line x1="0" y1="90" x2="47" y2="45" stroke="#777" strokeWidth="1.5"/>
      <line x1="100" y1="90" x2="53" y2="45" stroke="#777" strokeWidth="1.5"/>
      <circle cx="47" cy="45" r="3" fill="#e5e5e5"/>
      <circle cx="53" cy="45" r="3" fill="#e5e5e5"/>
    </g>
  </svg>
);
...
const ChestCableSeated = ({ color }: { color: string }) => (
  ...
  <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md">
    ...
    <g>
      <animate attributeName="opacity" values="1;0;1" keyTimes="0;0.5;1" dur="2s" repeatCount="indefinite"/>
      <path d="M 42 38 L 25 45 M 58 38 L 75 45" stroke={color} strokeWidth="4" fill="none" strokeLinecap="round"/>
    ...
    <g opacity="0">
      <animate attributeName="opacity" values="0;1;0" keyTimes="0;0.5;1" dur="2s" repeatCount="indefinite"/>
      <path d="M 42 38 L 47 48 M 58 38 L 53 48" stroke={color} strokeWidth="4" fill="none" strokeLinecap="round"/>
...
const ShoulderDbSeated = ({ color }: { color: string }) => (
  <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md">
    ...
    <g>
      <animate attributeName="opacity" values="1;0;1" keyTimes="0;0.5;1" dur="1.8s" repeatCount="indefinite"/>
      <path d="M 60 36 L 66 48 L 56 40" stroke={color} strokeWidth="3.5" fill="none" strokeLinejoin="round"/>
...
const LateralDb = ({ color }: { color: string }) => (
  <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md">
    ...
    <g>
      <animate attributeName="opacity" values="1;0;1" keyTimes="0;0.5;1" dur="1.8s" repeatCount="indefinite"/>
      <path d="M 40 28 L 35 40 L 35 55" stroke={color} strokeWidth="4" fill="none" strokeLinejoin="round"/>
      <path d="M 60 28 L 65 40 L 65 55" stroke={color} strokeWidth="4" fill="none" strokeLinejoin="round"/>
      <circle cx="35" cy="57" r="3" fill="#e5e5e5"/>
      <circle cx="65" cy="57" r="3" fill="#e5e5e5"/>
    </g>
    <g opacity="0">
      <animate attributeName="opacity" values="0;1;0" keyTimes="0;0.5;1" dur="1.8s" repeatCount="indefinite"/>
      <path d="M 40 28 L 25 32 L 15 35" stroke={color} strokeWidth="4" fill="none" strokeLinejoin="round"/>
      <path d="M 60 28 L 75 32 L 85 35" stroke={color} strokeWidth="4" fill="none" strokeLinejoin="round"/>
...
const ShoulderLateralCable = ({ color }: { color: string }) => (
  <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md">
    ...
    <g>
      <animate attributeName="opacity" values="1;0;1" keyTimes="0;0.5;1" dur="1.8s" repeatCount="indefinite"/>
      <path d="M 40 28 L 35 45 M 60 28 L 65 45" stroke={color} strokeWidth="4" fill="none" strokeLinecap="round"/>
      <line x1="10" y1="90" x2="65" y2="45" stroke="#777" strokeWidth="1.5"/>
      <line x1="90" y1="90" x2="35" y2="45" stroke="#777" strokeWidth="1.5"/>
      <circle cx="35" cy="45" r="3" fill="#e5e5e5"/>
      <circle cx="65" cy="45" r="3" fill="#e5e5e5"/>
    </g>
    <g opacity="0">
      <animate attributeName="opacity" values="0;1;0" keyTimes="0;0.5;1" dur="1.8s" repeatCount="indefinite"/>
      <path d="M 40 28 L 15 35 M 60 28 L 85 35" stroke={color} strokeWidth="4" fill="none" strokeLinecap="round"/>
      <line x1="10" y1="90" x2="85" y2="35" stroke="#777" strokeWidth="1.5"/>
      <line x1="90" y1="90" x2="15" y2="35" stroke="#777" strokeWidth="1.5"/>
...
const ShoulderLateralMachine = ({ color }: { color: string }) => (
  <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md">
    ...
    <g>
      <animate attributeName="opacity" values="1;0;1" keyTimes="0;0.5;1" dur="1.8s" repeatCount="indefinite"/>
      <path d="M 50 28 L 40 28 L 40 45" stroke={color} strokeWidth="4" fill="none" strokeLinejoin="round"/>
      <path d="M 50 28 L 60 28 L 60 45" stroke={color} strokeWidth="4" fill="none" strokeLinejoin="round"/>
      <rect x="37" y="40" width="6" height="10" fill="#e5e5e5" rx="1"/>
      <rect x="57" y="40" width="6" height="10" fill="#e5e5e5" rx="1"/>
    </g>
    <g opacity="0">
      <animate attributeName="opacity" values="0;1;0" keyTimes="0;0.5;1" dur="1.8s" repeatCount="indefinite"/>
      <path d="M 50 28 L 25 28 L 25 15" stroke={color} strokeWidth="4" fill="none" strokeLinejoin="round"/>
      <path d="M 50 28 L 75 28 L 75 15" stroke={color} strokeWidth="4" fill="none" strokeLinejoin="round"/>
      <rect x="22" y="10" width="6" height="10" fill="#e5e5e5" rx="1"/>
      <rect x="72" y="10" width="6" height="10" fill="#e5e5e5" rx="1"/>
    </g>
  </svg>
);
...
const BackLatTriangle = ({ color }: { color: string }) => (
  <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md">
    ...
    <g>
      <animate attributeName="opacity" values="1;0;1" keyTimes="0;0.5;1" dur="2s" repeatCount="indefinite"/>
      <line x1="50" y1="0" x2="50" y2="20" stroke="#666" strokeWidth="2"/>
      <polygon points="50,20 45,30 55,30" fill="#e5e5e5"/>
      <path d="M 42 43 L 38 35 L 45 30" stroke={color} strokeWidth="3.5" fill="none" strokeLinecap="round"/>
      <path d="M 58 43 L 62 35 L 55 30" stroke={color} strokeWidth="3.5" fill="none" strokeLinecap="round"/>
    </g>
    <g opacity="0">
      <animate attributeName="opacity" values="0;1;0" keyTimes="0;0.5;1" dur="2s" repeatCount="indefinite"/>
      <line x1="50" y1="0" x2="50" y2="40" stroke="#666" strokeWidth="2"/>
      <polygon points="50,40 45,50 55,50" fill="#e5e5e5"/>
      <path d="M 42 43 L 38 55 L 45 50" stroke={color} strokeWidth="3.5" fill="none" strokeLinecap="round"/>
      <path d="M 58 43 L 62 55 L 55 50" stroke={color} strokeWidth="3.5" fill="none" strokeLinecap="round"/>
    </g>
  </svg>
);
...
const BackPullup = ({ color }: { color: string }) => (
  <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md">
    ...
    <g>
      ...
      <path d="M 30 15 L 36 30 L 42 43" stroke={color} strokeWidth="4" fill="none" strokeLinejoin="round"/>
      <path d="M 70 15 L 64 30 L 58 43" stroke={color} strokeWidth="4" fill="none" strokeLinejoin="round"/>
    </g>
    <g opacity="0">
      <animate attributeName="opacity" values="0;1;0" keyTimes="0;0.5;1" dur="1.8s" repeatCount="indefinite"/>
      ...
      <path d="M 30 15 L 25 35 L 42 23" stroke={color} strokeWidth="4" fill="none" strokeLinejoin="round"/>
      <path d="M 70 15 L 75 35 L 58 23" stroke={color} strokeWidth="4" fill="none" strokeLinejoin="round"/>
    </g>
  </svg>
);
...
const BackRowBarbell = ({ color }: { color: string }) => (
  <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md">
    ...
    <g>
      <animate attributeName="opacity" values="1;0;1" keyTimes="0;0.5;1" dur="1.8s" repeatCount="indefinite"/>
      <path d="M 60 35 L 60 55 L 60 70" stroke={color} strokeWidth="3.5" fill="none" strokeLinejoin="round"/>
    ...
    <g opacity="0">
      <animate attributeName="opacity" values="0;1;0" keyTimes="0;0.5;1" dur="1.8s" repeatCount="indefinite"/>
      <path d="M 60 35 L 40 25 L 50 48" stroke={color} strokeWidth="3.5" fill="none" strokeLinejoin="round"/>
...
const BackPulley = ({ color }: { color: string }) => (
  <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md">
    ...
    <g>
      <animate attributeName="opacity" values="1;0;1" keyTimes="0;0.5;1" dur="1.8s" repeatCount="indefinite"/>
      <path d="M 30 35 L 45 42 L 60 50" stroke={color} strokeWidth="3.5" fill="none" strokeLinejoin="round"/>
      <line x1="60" y1="50" x2="80" y2="50" stroke="#888" strokeWidth="1.5"/>
      <rect x="58" y="47" width="4" height="6" fill="#e5e5e5" rx="1"/>
    </g>
    <g opacity="0">
      <animate attributeName="opacity" values="0;1;0" keyTimes="0;0.5;1" dur="1.8s" repeatCount="indefinite"/>
      <path d="M 30 35 L 15 42 L 35 50" stroke={color} strokeWidth="3.5" fill="none" strokeLinejoin="round"/>
...
const BackPulloverCable = ({ color }: { color: string }) => (
  ...
  <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md">
    ...
    <g>
      <animate attributeName="opacity" values="1;0;1" keyTimes="0;0.5;1" dur="2s" repeatCount="indefinite"/>
      <path d="M 65 33 L 45 35 L 35 30" stroke={color} strokeWidth="3.5" fill="none" strokeLinecap="round"/>
      <line x1="35" y1="15" x2="35" y2="30" stroke="#888" strokeWidth="1.5"/>
      <rect x="33" y="28" width="4" height="6" fill="#e5e5e5" rx="1"/>
    </g>
    <g opacity="0">
      <animate attributeName="opacity" values="0;1;0" keyTimes="0;0.5;1" dur="2s" repeatCount="indefinite"/>
      <path d="M 65 33 L 55 55 L 45 70" stroke={color} strokeWidth="3.5" fill="none" strokeLinecap="round"/>
      <line x1="35" y1="15" x2="45" y2="70" stroke="#888" strokeWidth="1.5"/>
      <rect x="43" y="68" width="4" height="6" fill="#e5e5e5" rx="1"/>
    </g>
  </svg>
);
...
const LegSquat = ({ color }: { color: string }) => (
  <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md">
    ...
    <g>
      ...
      <path d="M 50 45 L 53 65 L 50 85 M 50 85 L 58 85" stroke={color} strokeWidth="4.5" fill="none" strokeLinejoin="round"/>
    ...
    <g opacity="0">
      ...
      <path d="M 35 65 L 60 65 L 50 85 M 50 85 L 58 85" stroke={color} strokeWidth="4.5" fill="none" strokeLinejoin="round"/>
...
const LegPress = ({ color }: { color: string }) => (
  <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md">
    ...
    <g>
      <animate attributeName="opacity" values="1;0;1" keyTimes="0;0.5;1" dur="1.8s" repeatCount="indefinite"/>
      <path d="M 50 85 L 45 65 L 35 70" stroke={color} strokeWidth="4.5" fill="none" strokeLinejoin="round"/>
...
const LegExtension = ({ color }: { color: string }) => (
  <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md">
    ...
    <g>
      <animate attributeName="opacity" values="1;0;1" keyTimes="0;0.5;1" dur="1.8s" repeatCount="indefinite"/>
      <path d="M 55 55 L 55 80 M 50 80 L 60 80" stroke={color} strokeWidth="4.5" fill="none" strokeLinejoin="round"/>
      <circle cx="55" cy="75" r="4" fill="#e5e5e5"/>
    </g>
    <g opacity="0">
      <animate attributeName="opacity" values="0;1;0" keyTimes="0;0.5;1" dur="1.8s" repeatCount="indefinite"/>
      <path d="M 55 55 L 80 55 M 80 50 L 80 60" stroke={color} strokeWidth="4.5" fill="none" strokeLinejoin="round"/>
...
const LegCurl = ({ color }: { color: string }) => (
  <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md">
    ...
    <g>
      <animate attributeName="opacity" values="1;0;1" keyTimes="0;0.5;1" dur="1.8s" repeatCount="indefinite"/>
      <path d="M 70 52 L 95 52 M 95 52 L 95 58" stroke={color} strokeWidth="4.5" fill="none" strokeLinejoin="round"/>
      <circle cx="90" cy="50" r="4" fill="#e5e5e5"/>
    </g>
    <g opacity="0">
      <animate attributeName="opacity" values="0;1;0" keyTimes="0;0.5;1" dur="1.8s" repeatCount="indefinite"/>
      <path d="M 70 52 L 60 28 M 60 28 L 65 24" stroke={color} strokeWidth="4.5" fill="none" strokeLinejoin="round"/>
    ...
    <div className="w-16 h-16 bg-neutral-900 rounded-lg border border-neutral-700 flex items-center justify-center shadow-inner shrink-0 p-1">
      {(() => {
        switch (animKey) {
          ...
          case 'back_pulldown': return <BackLatPulldown color={color} />; 
