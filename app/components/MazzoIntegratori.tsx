...
function Carta({
  ...
  // GESTIONE PAN: dedicato solo allo swipe verticale sulla carta
  ...
  // GESTIONE DRAG: dedicato solo allo swipe orizzontale di archiviazione
  ...
  return (
    <motion.div
      ...
      dragElastic={0.8}
      // Aggiunto onPanEnd indipendente per lo scorrimento verticale
